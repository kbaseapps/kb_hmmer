...
function kb_hmmer(url, auth, auth_cb, timeout, async_job_check_time_ms, async_version) {
    var self = this;
    ...
    this._check_job = function (job_id, _callback, _errorCallback) {
        ...
        return json_call_ajax("kb_hmmer._check_job", 
     ...
     this.HMMER_MSA_Search = function (params, _callback, _errorCallback) {
        ...
        return json_call_ajax("kb_hmmer.HMMER_MSA_Search",
